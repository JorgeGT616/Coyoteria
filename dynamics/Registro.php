          ...
          <fieldset class='aber'>
            ...
            <form  action='revision.php' method='post'>
              ...
              <tr>
                <th>Nombre:</th>
                <th>
                  <input type='text' name='Nombre' value='' placeholder = 'Ej: Andreo' maxlength='40'
              ...
              <tr>
                ...
                <th>
                  <input type='text' name='numcuen'  style='width : 170px;' placeholder = 'Ej: 318999909 (sin guiones)' title = 'El formato debe coincidir con el número de cuente (9 dígitos sin guiones)'
              ...
              <tr>
                <th>Contraseña:</th>
                <th>
                  <input type='password' name='contrasena' value='' placeholder ='*******' minlength='6' maxlength='16'
          ...
          <fieldset class='aber'>
            ...
            <form action='revision.php' method='post'>
              ...
              <tr>
                <th>Nombre:</th>
                <th>
                  <input type='text' name='Nombre' value='' placeholder = 'Ej: Isauro' maxlength='40'
                  pattern = '^[A-Za-zá-úÁ-Úä-üÄ-Ü][A-Za-zá-úÁ-Úä-üÄ-Ü\- ]*' title ='Coloque su nombre' required>
                </th>
              </tr>
              <tr>
              ...
              <tr>
                <th>RFC:</th>
                <th>
                  <input type='text' name='correo' value='' placeholder = 'Ej: FIRI8505137A3' title = 'El formato debe coincider con el de RFC'
